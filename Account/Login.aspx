<%@ Page Title="Iniciar sesión" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="WebApplicationDui2.Account.Login" Async="true" %>
...
<%--                    <h4>Ingrese los datos de su cuenta:</h4>--%>
                ...
                <br />
                <p>
                    <asp:HyperLink runat="server" class="link-secondary link-offset-2 link-underline-opacity-25 link-underline-opacity-100-hover" ID="RegisterHyperLink" ViewStateMode="Disabled">Registrarse como usuario nuevo</asp:HyperLink>
                </p>
                <p>
