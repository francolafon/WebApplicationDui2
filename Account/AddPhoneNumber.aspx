<%@ Page Title="Número de teléfono" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AddPhoneNumber.aspx.cs" Inherits="WebApplicationDui2.Account.AddPhoneNumber" %>

<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    <main aria-labelledby="title">
        <%--<h2 id="title"><%: Title %>.</h2>--%>
        <h2 id="title">Contacto</h2>
        <p>Para mas información puede llamar al 0800 111 2222.</p>
        <p>También puede visitarnos en Calle Santa Rosa N°4000, barrio Centro, Cordoba Capital, Argentina.</p>
        <h4> Déjanos tus datos y nosotros nos comunicamos:</h4>
        <hr />
