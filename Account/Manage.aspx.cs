...
using Owin;
using WebApplicationDui2.Models;

namespace WebApplicationDui2.Account
{
    public partial class Manage : System.Web.UI.Page
    {
        ...
        protected void CambiarButton_Click(object sender, EventArgs e)
        {
            Response.Redirect("/Account/ManangePassword");
        }
    }
}